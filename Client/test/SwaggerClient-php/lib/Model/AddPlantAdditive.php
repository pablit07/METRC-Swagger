...
/**
 * AddPlantAdditive Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddPlantAdditive implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddPlantAdditive';
...
'actual_date' => 'getActualDate'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['plant_labels'] = isset($data['plant_labels']) ? $data['plant_labels'] : null;
     ...
     * @return string[]
     */
    public function getPlantLabels()
    {
        return $this->container['plant_labels'];
    }

    /**
     * Sets plant_labels
     *
     * @param string[] $plant_labels plant_labels
     *
     * @return $this
     */
    public function setPlantLabels($plant_labels)
    {
        $this->container['plant_labels'] = $plant_labels;
